              ...
              child: Column(
                ...
                children: <Widget>[
                   ...
                   const  Text('  Let’s help you meet your tasks', style: TextStyle( fontSize: 15),),
                    ...
                    TextFieldExample(hintText: 'Enter your full name',controller: _name,validator: "Name",
                    icon: Icon(Icons.person),
                    
                    ),
                     const SizedBox(height: 20,),
                     TextFieldExample(hintText: 'Enter your email',controller: _email,validator: "Email",
                       icon: Icon(Icons.email_outlined),
                     ),
                      const SizedBox(height: 20,),
                     TextFieldExample(hintText: 'Enter password',controller: _password,validator: "Password",
                         icon: Icon(Icons.password_outlined)
                     ),
                     const SizedBox(height: 20,),
                     TextFieldExample(hintText: 'Confirm password',controller: _cpassword,validator: "Confirm Password",
