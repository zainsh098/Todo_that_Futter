              ...
              child: Column(
                ...
                children: <Widget>[
                   ...
                   const  Text('  Let’s help you meet your tasks', style: TextStyle( fontSize: 15),),
                    ...
                    TextFieldExample(hintText: 'Enter Email',controller: _email,validator: "Name",icon: Icon(Icons.email),),
                     const SizedBox(height: 20,),
                    TextFieldExample(hintText: 'Enter Password',controller: _password,validator: "Password",icon: Icon(Icons.password)),
